...
final class ToolVersions {
    private final static String LATEST_PMD_TOOL_VERSION = '5.7.0'
    ...
    private final static String LATEST_CHECKSTYLE_VERSION = '7.7'
    ...
    private final static String FB_CONTRIB_VERSION = '7.0.1'
