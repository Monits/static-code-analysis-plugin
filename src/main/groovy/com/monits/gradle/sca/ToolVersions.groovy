...
final class ToolVersions {
    private final static String LATEST_PMD_TOOL_VERSION = '6.17.0'
    ...
    private final static String LATEST_CHECKSTYLE_VERSION = '8.21'
    ...
    private final static String FB_CONTRIB_VERSION = '7.4.3'
