...
final class ToolVersions {
    private final static String LATEST_PMD_TOOL_VERSION = '5.5.1'
    ...
    private final static String LATEST_CHECKSTYLE_VERSION = '7.1.2'
    ...
    private final static String FB_CONTRIB_VERSION = '6.8.0'
