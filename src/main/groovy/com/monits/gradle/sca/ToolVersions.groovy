...
final class ToolVersions {
    private final static String LATEST_PMD_TOOL_VERSION = '6.5.0'
    ...
    private final static String LATEST_CHECKSTYLE_VERSION = '8.10.1'
    ...
    private final static String FB_CONTRIB_VERSION = '7.4.1'
