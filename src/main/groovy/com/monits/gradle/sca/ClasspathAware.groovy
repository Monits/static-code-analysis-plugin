...
trait ClasspathAware {
     ...
     */
    FileCollection getProjectClassTree(final Project project, final String path, final String sourceSetName) {
        Project childProj = project.rootProject.findProject(':' + path)
        if (childProj == null) {
            return project.files()
        }
        getProjectClassTree(childProj, sourceSetName)
    }
